      ...
      <Row className='d-flex justify-content-center'>
        <Col className='mb-5' xs={12} lg={10}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='d-flex justify-content-end me-4 mb-3' as='h1'>Meyer's Meet App</Card.Title>
        ...
        <Col className='my-5' xs={12} lg={10}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='d-flex justify-content-end me-4 mb-3' as='h1'>Meyer's Messages App</Card.Title>
              <Card.Text className='mb-3 portfolio-main-font'>
        ...
        <Col className='my-5' xs={12} lg={10}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='d-flex justify-content-end me-4 mb-3' as='h1'>Meyer's Movies (React)</Card.Title>
              <Card.Text className='mb-3 portfolio-main-font'>
        ...
        <Col className='my-5' xs={12} lg={10}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='d-flex justify-content-end me-4 mb-3' as='h1'>Meyer's Movies (Angular)</Card.Title>
              <Card.Text className='mb-3 portfolio-main-font'>
                Meyer's Messages is a chat app that was built using React Native and tested using an Android Emulator. The app provides users with a chat interface and options to share their location and/or images. Images may be shared either from the devices media library, or directly from the camera within the app.
              </Card.Text>
              <Container>
        ...
        <Col className='my-5' xs={12} lg={10}>
          <Card>
            ...
            <Card.Body>
              <Card.Title className='d-flex justify-content-end me-4 mb-3' as='h1'>Pokedex App</Card.Title>
              <Card.Text className='mb-3 portfolio-main-font'>

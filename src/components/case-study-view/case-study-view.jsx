...
export const CaseStudyView = () => {
  return (
    <>
      <Container>
        <Row className="d-flex justify-content-center pb-0 pb-lg-5">
          ...
          <Col className="d-flex flex-column justify-content-center mb-5 mb-lg-0" xs={12} lg={4}>
          ...
          <Col className="d-flex flex-column justify-content-center mb-5 mb-lg-0" xs={12} lg={6}>
        ...
        <Row className="py-5 d-flex justify-content-center">
          ...
          <Col className="d-flex flex-column justify-content-center ps-0 ps-lg-4" xs={12} lg={4}>
        ...
        <Col className="d-flex flex-column align-items-center mb-5"  xs={12}>
            <h1 style={{ fontWeight: "bold" }}>My Approach</h1>
          </Col>
        ...
        <Row className="d-flex justify-content-center mt-3 pb-5">
          ...
          <Col className="d-flex flex-column justify-content-center" xs={12} lg={6}>
            <img src={require("../../img/myFlixPostmanExample.png")} alt="API Call on Postman to post a user's favorite movie" />
          </Col>
        </Row>

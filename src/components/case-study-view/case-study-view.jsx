    ...
    <>
      <Container>
        <Row>
          ...
          <Col className="d-flex flex-column justify-content-center" sm={12} md={5}>
          ...
          <Col className="d-flex flex-column justify-content-center" sm={12} md={7}>
            <Image variant='top' src={require("../../img/MeyersMoviesReact.png")} />
          </Col>
        </Row>
        <Row className="mt-6">
          <Col className="d-flex flex-column justify-content-center" xs={12} md={7}>
            <Image variant='top' src={require("../../img/MyFlixArchDiagram.png")} />
          </Col>
          <Col className="d-flex flex-column justify-content-center" xs={12} md={5}>
        ...
        <Row className="mt-6">
          <h1 className="mb-5">My Approach</h1>
            ...
            <Carousel data-bs-theme="dark" className="carousel">
              <Carousel.Item>
                ...
                <Carousel.Caption className="carousel-label">
                  <h3>Learning React Components</h3>
                </Carousel.Caption>
              </Carousel.Item><Carousel.Item>
                <Image src={require("../../img/ConnectingToDatabaseThumbnail.png")} />
                <Carousel.Caption>
                  <h3>React Hooks / Conneting to Database</h3>
                </Carousel.Caption>
              </Carousel.Item>
              <Carousel.Item>

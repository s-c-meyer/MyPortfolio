      ...
      <Container fluid className="footer-container">
        ...
        <Row>
          ...
          <Col xs={12} lg={4} className="d-flex justify-content-center align-items-end mb-4">
            <span className="footer-text--no-shadow">© {currentYear} samuelmeyer.dev</span>
          </Col>
        </Row>
      </Container>
    </>
